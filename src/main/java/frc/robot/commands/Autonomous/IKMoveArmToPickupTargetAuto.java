...
public class IKMoveArmToPickupTargetAuto extends MoveLegAnkleToPositionCommand {
  private int pickupIndex;
  private FieldPosManager fieldPosManager;

  /** Creates a new MoveArmToTarget. */
  public IKMoveArmToPickupTargetAuto(int pickupIndex, LegAnkleSubsystem legAnkleSubsystem, FieldPosManager fieldPosManager) {
