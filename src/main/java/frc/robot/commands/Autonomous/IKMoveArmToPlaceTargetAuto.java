...
public class IKMoveArmToPlaceTargetAuto extends MoveLegAnkleToPositionCommand {
  ...
  public IKMoveArmToPlaceTargetAuto(boolean isCube, LegAnkleSubsystem legAnkleSubsystem, FieldPosManager fieldPosManager) {
